...
import '../../listes/Recept_samples/Recept_bi.dart';

class Receptdeatilsbi extends StatelessWidget {
  const Receptdeatilsbi({super.key});
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => ReceptBi()));
        },
        child: Stack(
          children: [
            Column(
