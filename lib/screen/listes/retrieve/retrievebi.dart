...
class Retrievebi extends StatefulWidget {
  const Retrievebi({super.key});

  @override
  State<Retrievebi> createState() => _RetrievebiState();
}

class _RetrievebiState extends State<Retrievebi> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Liste des résultats BI récupérés',
