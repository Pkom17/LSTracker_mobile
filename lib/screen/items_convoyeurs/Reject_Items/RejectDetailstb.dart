...
import '../../listes/Reject_sample/Rejecttb.dart';

class Rejectdetailstb extends StatelessWidget {
  const Rejectdetailstb({super.key});
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => Rejecttb()));
        },
        child: Stack(
          children: [
            Column(
