...
import '../../listes/Submit_result/Submit_tb.dart';

class Submitdetailstb extends StatelessWidget {
  const Submitdetailstb({super.key});
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => SubmitTb()));
        },
        child: Stack(
          children: [
            Column(
