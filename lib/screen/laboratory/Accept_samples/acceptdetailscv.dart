...
import '../../listes/Accept_samples/accept_samplecv.dart';

class Acceptdetailscv extends StatelessWidget {
  const Acceptdetailscv({super.key});
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => AcceptSamplecv()));
        },
        child: Stack(
          children: [
            Column(
