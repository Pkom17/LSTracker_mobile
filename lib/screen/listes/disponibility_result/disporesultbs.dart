...
class Disporesultbs extends StatefulWidget {
  const Disporesultbs({super.key});

  @override
  State<Disporesultbs> createState() => _DisporesultbsState();
}

class _DisporesultbsState extends State<Disporesultbs> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Liste des résultats BS disponible',
