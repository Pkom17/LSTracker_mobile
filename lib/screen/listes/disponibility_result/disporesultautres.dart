...
class Disporesultautres extends StatefulWidget {
  const Disporesultautres({super.key});

  @override
  State<Disporesultautres> createState() => _DisporesultautresState();
}

class _DisporesultautresState extends State<Disporesultautres> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          "Liste des autres résultats disponible",
      ...
      body: Column(
        children: [
          ...
          Text("Autres résultats pas disponibles")
