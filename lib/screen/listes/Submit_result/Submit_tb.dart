...
class SubmitTb extends StatefulWidget {
  const SubmitTb({super.key});

  @override
  State<SubmitTb> createState() => _SubmitTbState();
}

class _SubmitTbState extends State<SubmitTb> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Listes des résultats TB à deposer',
      ...
      body: Column(
        children: [
          ...
          Text("Resultats TB à deposer pas disponibles")
