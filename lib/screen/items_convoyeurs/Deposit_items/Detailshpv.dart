...
import '../../listes/Collect_sample/deposithpv.dart';

class Detailshpv extends StatelessWidget {
  const Detailshpv({super.key});
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => Deposithpv()));
        },
        child: Stack(
          children: [
            Column(
