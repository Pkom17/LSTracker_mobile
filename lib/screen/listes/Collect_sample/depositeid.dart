...
class Depositeid extends StatefulWidget {
  const Depositeid({super.key});

  @override
  State<Depositeid> createState() => _DepositeidState();
}

class _DepositeidState extends State<Depositeid> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Listes des échantillons EID à déposer',
      ...
      body: Column(
        children: [
          ...
          Text("Echantillons EID à déposer")
        ],
      ),
    );
  }
