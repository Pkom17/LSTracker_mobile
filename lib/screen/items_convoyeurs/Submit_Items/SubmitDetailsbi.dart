...
import '../../listes/Submit_result/Submit_bi.dart';

class Submitdetailsbi extends StatelessWidget {
  const Submitdetailsbi({super.key});
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => SubmitBi()));
        },
        child: Stack(
          children: [
            Column(
