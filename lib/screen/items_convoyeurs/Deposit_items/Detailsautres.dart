...
import '../../listes/Collect_sample/depositautre.dart';

class Detailsautres extends StatelessWidget {
  const Detailsautres({super.key});
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => Depositautre()));
        },
        child: Stack(
          children: [
            Column(
