...
/*Echantillons rejetés aux laboratoires*/
class Samplereject extends StatelessWidget {
  const Samplereject({super.key});
            ...
            child: InkWell(
              onTap: () {
                Navigator.of(context).push(
                    MaterialPageRoute(builder: (context) => Rejectliste()));
              },
            ),
          ),
          Positioned(
