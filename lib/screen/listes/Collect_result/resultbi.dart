...
class Resultbi extends StatefulWidget {
  const Resultbi({super.key});

  @override
  State<Resultbi> createState() => _ResultbiState();
}

class _ResultbiState extends State<Resultbi> {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Text("Resultats BI pas disponibles")
