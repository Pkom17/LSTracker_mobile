...
import '../../listes/Reject_sample/Rejectcv.dart';

class Rejectdetailscv extends StatelessWidget {
  const Rejectdetailscv({super.key});
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => Rejectcv()));
        },
        child: Stack(
          children: [
            Column(
