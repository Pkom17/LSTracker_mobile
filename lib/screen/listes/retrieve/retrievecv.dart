...
import 'package:lstracker/qr/qr_generator_screen.dart';

class Retrievecv extends StatefulWidget {
  const Retrievecv({super.key});

  @override
  State<Retrievecv> createState() => _RetrievecvState();
}

class _RetrievecvState extends State<Retrievecv> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Liste des résultats CV récupérés',
