...
class Disporesultcv extends StatefulWidget {
  const Disporesultcv({super.key});

  @override
  State<Disporesultcv> createState() => _DisporesultcvState();
}

class _DisporesultcvState extends State<Disporesultcv> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Liste des résultats CV disponible',
      ...
      body: Column(
        children: [
          ...
          Text("Résultats BS pas disponibles")
