...
class Disporesulttb extends StatefulWidget {
  const Disporesulttb({super.key});

  @override
  State<Disporesulttb> createState() => _DisporesulttbState();
}

class _DisporesulttbState extends State<Disporesulttb> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Liste des résultats TB disponible',
      ...
      body: Column(
        children: [
          ...
          Text("Résultats TB pas disponible")
