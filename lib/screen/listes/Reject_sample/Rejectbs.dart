...
class Rejectbs extends StatefulWidget {
  const Rejectbs({super.key});

  @override
  State<Rejectbs> createState() => _RejectbsState();
}

class _RejectbsState extends State<Rejectbs> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Echantillons Réjetés BS',
      ...
      body: Column(
        children: [
          ...
          Text("Aucun des échantillons BS réjetés")
