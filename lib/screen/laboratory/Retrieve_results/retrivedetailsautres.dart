...
import '../../listes/retrieve/retrieveautres.dart';

class RetrivedetailsAutres extends StatelessWidget {
  const RetrivedetailsAutres({super.key});
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => Retrieveautres()));
        },
        child: Stack(
          children: [
            Column(
