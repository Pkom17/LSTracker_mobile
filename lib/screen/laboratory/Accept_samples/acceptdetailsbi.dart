...
import '../../listes/Accept_samples/accept_samplebi.dart';

class Acceptdetailsbi extends StatelessWidget {
  const Acceptdetailsbi({super.key});
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => AcceptSamplebi()));
        },
        child: Stack(
          children: [
            Column(
