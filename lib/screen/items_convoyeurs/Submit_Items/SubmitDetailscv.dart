...
import '../../listes/Submit_result/submit_cv.dart';

class Submitdetailscv extends StatelessWidget {
  const Submitdetailscv({super.key});
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => SubmitCv()));
        },
        child: Stack(
          children: [
            Column(
