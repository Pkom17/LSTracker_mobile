...
import '../../listes/Reject_sample/Rejectbi.dart';

class Rejectdetailsbi extends StatelessWidget {
  const Rejectdetailsbi({super.key});
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => Rejectbi()));
        },
        child: Stack(
          children: [
            Column(
