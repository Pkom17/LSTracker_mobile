...
import '../../listes/disponibility_result/disporesultbi.dart';

class Resultdetailsbi extends StatelessWidget {
  const Resultdetailsbi({super.key});
    ...
    return Card(
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.of(
            context,
          ).push(MaterialPageRoute(builder: (context) => Disporesultbi()));
        },
        child: Stack(
          children: [
            Column(
