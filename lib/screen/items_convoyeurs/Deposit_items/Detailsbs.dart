...
import '../../listes/Collect_sample/depositbs.dart';

class Detailsbs extends StatelessWidget {
  const Detailsbs({super.key});
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => Depositbs()));
        },
        child: Stack(
          children: [
            Column(
