...
import '../../listes/disponibility_result/disporesultbs.dart';

class Resultdetailsbs extends StatelessWidget {
  const Resultdetailsbs({super.key});
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => Disporesultbs()));
        },
        child: Stack(
          children: [
            Column(
