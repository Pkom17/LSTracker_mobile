...
import '../../widgets/AcceptSample_details.dart';
import 'package:transparent_image/transparent_image.dart';

class Acceptsample extends StatefulWidget {
  const Acceptsample({super.key});
  ...
  void validateSample() {
    setState(() {
      Navigator.of(context)
          .push(MaterialPageRoute(builder: (context) => AcceptsampleDetails()));
    });
  }
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    Text(
                      "Liste des échantillons acceptés",
                      maxLines: 2,
