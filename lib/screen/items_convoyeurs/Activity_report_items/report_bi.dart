...
import '../../../screen/listes/Report_activity/reportbi_list.dart';

class ReportBi extends StatelessWidget {
  const ReportBi({super.key});
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => ReportbiList()));
        },
        child: Stack(
          children: [
            Column(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            Text(
                              'Bilans BI',
                              /* Item representant le point des echantillons collectés BI */
                              style: GoogleFonts.lato(
                                textStyle:
