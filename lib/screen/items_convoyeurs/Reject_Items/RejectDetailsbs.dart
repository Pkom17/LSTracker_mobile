...
import '../../listes/Reject_sample/Rejectbs.dart';

class Rejectdetailsbs extends StatelessWidget {
  const Rejectdetailsbs({super.key});
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => Rejectbs()));
        },
        child: Stack(
          children: [
            Column(
