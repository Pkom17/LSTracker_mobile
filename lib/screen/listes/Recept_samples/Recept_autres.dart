...
class Receptautres extends StatefulWidget {
  const Receptautres({super.key});

  @override
  State<Receptautres> createState() => _ReceptautresState();
}

class _ReceptautresState extends State<Receptautres> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Réceptionner autres Echantiilons',
      ...
      body: Column(
        children: [
          ...
          Text("Reception des autres Echantillons pas disponibles")
