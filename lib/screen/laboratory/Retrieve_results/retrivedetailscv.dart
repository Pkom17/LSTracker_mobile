...
import '../../listes/retrieve/retrievecv.dart';

class Retrivedetailscv extends StatelessWidget {
  const Retrivedetailscv({super.key});
    ...
    return Card(
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.of(
            context,
          ).push(MaterialPageRoute(builder: (context) => Retrievecv()));
        },
        child: Stack(
          children: [
            Column(
