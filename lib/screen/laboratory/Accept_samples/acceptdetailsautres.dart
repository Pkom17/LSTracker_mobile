...
import '../../listes/Accept_samples/accept_sampleautres.dart';

class Acceptdetailsautres extends StatelessWidget {
  const Acceptdetailsautres({super.key});
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.of(context).push(
              MaterialPageRoute(builder: (context) => AcceptSampleAutres()));
        },
        child: Stack(
          children: [
            Column(
