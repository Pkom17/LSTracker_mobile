...
class AcceptSamplehpv extends StatefulWidget {
  const AcceptSamplehpv({super.key});

  @override
  State<AcceptSamplehpv> createState() => _AcceptSamplehpvState();
}

class _AcceptSamplehpvState extends State<AcceptSamplehpv> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Accepter Echantillons HPV',
      ...
      body: Column(
        children: [
          ...
          Text("Aucun échantillon HPV à accepter")
