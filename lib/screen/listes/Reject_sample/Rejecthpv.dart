...
class Rejecthpv extends StatefulWidget {
  const Rejecthpv({super.key});

  @override
  State<Rejecthpv> createState() => _RejecthpvState();
}

class _RejecthpvState extends State<Rejecthpv> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Echantillons Réjetés HPV',
      ...
      body: Column(
        children: [
          ...
          Text("Aucun des échantillons HPV réjetés")
