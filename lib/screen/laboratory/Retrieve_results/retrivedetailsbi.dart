...
import '../../listes/retrieve/retrievebi.dart';

class Retrivedetailsbi extends StatelessWidget {
  const Retrivedetailsbi({super.key});
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => Retrievebi()));
        },
        child: Stack(
          children: [
            Column(
