...
import '../../listes/retrieve/retrievehpv.dart';

class Retrivedetailshpv extends StatelessWidget {
  const Retrivedetailshpv({super.key});
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => Retrievehpv()));
        },
        child: Stack(
          children: [
            Column(
