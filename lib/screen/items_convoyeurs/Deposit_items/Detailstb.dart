...
import '../../listes/Collect_sample/deposittb.dart';

class Detailstb extends StatelessWidget {
  const Detailstb({super.key});
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => Deposittb()));
        },
        child: Stack(
          children: [
            Column(
