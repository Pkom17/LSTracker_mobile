...
class _DashboardUserScreenState extends State<DashboardUserScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final userRole = AuthUtils.roleOrNull() ?? 'USER';
    return Scaffold(
          appBar: AppBar(
          ...
          body: RefreshIndicator(
            ...
            child: ListView(
              ...
              children: [
                ...
                SectionHeader(
                  title: 'Échantillons',
                  badge: collected + delivered + received,
                ),
                ...
                SectionHeader(
                  title: 'Résultats',
                  badge: resultReady + resultCollected + resultDeposited,
                ),
                const SizedBox(height: 10),
                CardsGrid(
                  cards: [
                    ...
                    StatusCard(
                      ...
                      onTap: resultCollected == 0
                          ...
                          : () {
                              Navigator.of(context)
                                  .pushNamed(
                                      ResultsCollectedSitesScreen.route)
                                  .then((_) => _load());
                            },
                    ),
                    StatusCard(
                ...
                if (!loading && !hasAnyData) ...[
                  ...
                  const EmptyDashboardState(
                    ...
                    subtitle:
                        'Les données s\'afficheront ici après synchronisation.',
                  ),
                ],
