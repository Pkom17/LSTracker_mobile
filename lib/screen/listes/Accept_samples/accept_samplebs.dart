...
class AcceptSamplebs extends StatefulWidget {
  const AcceptSamplebs({super.key});

  @override
  State<AcceptSamplebs> createState() => _AcceptSamplebsState();
}

class _AcceptSamplebsState extends State<AcceptSamplebs> {
  @override
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Text("Aucun échantillon BS à accepter")
