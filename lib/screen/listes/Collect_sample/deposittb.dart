...
class Deposittb extends StatefulWidget {
  const Deposittb({super.key});

  @override
  State<Deposittb> createState() => _DeposittbState();
}

class _DeposittbState extends State<Deposittb> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Listes des échantillons TB à déposer',
      ...
      body: Column(
        children: [
          ...
          Text("Echantillons TB à déposer")
        ],
      ),
    );
  }
