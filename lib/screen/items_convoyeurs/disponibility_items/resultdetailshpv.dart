...
import '../../listes/disponibility_result/disporesulthpv.dart';

class Resultdetailshpv extends StatelessWidget {
  const Resultdetailshpv({super.key});
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => Disporesulthpv()));
        },
        child: Stack(
          children: [
            Column(
