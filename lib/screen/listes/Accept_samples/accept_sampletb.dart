...
class AcceptSampletb extends StatefulWidget {
  const AcceptSampletb({super.key});

  @override
  State<AcceptSampletb> createState() => _AcceptSampletbState();
}

class _AcceptSampletbState extends State<AcceptSampletb> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Accepter Echantillons TB',
      ...
      body: Column(
        children: [
          ...
          Text("Aucun échantillon TB à accepter")
