...
class ReceptCv extends StatefulWidget {
  const ReceptCv({super.key});

  @override
  State<ReceptCv> createState() => _ReceptCvState();
}

class _ReceptCvState extends State<ReceptCv> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Réceptionner Echantiilons CV',
      ...
      body: Column(
        children: [
          ...
          Text("Reception des Echantillons de CV pas disponibles")
