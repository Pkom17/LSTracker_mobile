...
class SubmitCv extends StatefulWidget {
  const SubmitCv({super.key});

  @override
  State<SubmitCv> createState() => _SubmitCvState();
}

class _SubmitCvState extends State<SubmitCv> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Listes des résultats CV à deposer',
      ...
      body: Column(
        children: [
          ...
          Text("Resultats CV à deposer pas disponibles")
