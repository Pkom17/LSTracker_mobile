...
import '../../listes/retrieve/retrievetb.dart';

class Retrivedetailstb extends StatelessWidget {
  const Retrivedetailstb({super.key});
    ...
    return Card(
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.of(
            context,
          ).push(MaterialPageRoute(builder: (context) => Retrievetb()));
        },
        child: Stack(
          children: [
            Column(
