...
class ReceptBs extends StatefulWidget {
  const ReceptBs({super.key});

  @override
  State<ReceptBs> createState() => _ReceptBsState();
}

class _ReceptBsState extends State<ReceptBs> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Réceptionner Echantiilons BS',
      ...
      body: Column(
        children: [
          ...
          Text("Reception des Echantillons de BS pas disponibles")
