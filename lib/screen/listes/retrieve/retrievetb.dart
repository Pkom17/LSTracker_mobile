...
class Retrievetb extends StatefulWidget {
  const Retrievetb({super.key});

  @override
  State<Retrievetb> createState() => _RetrievetbState();
}

class _RetrievetbState extends State<Retrievetb> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Liste des résultats TB récupérés',
