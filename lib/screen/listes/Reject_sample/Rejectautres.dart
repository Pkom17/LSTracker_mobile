...
class Rejectautres extends StatefulWidget {
  const Rejectautres({super.key});

  @override
  State<Rejectautres> createState() => _RejectautresState();
}

class _RejectautresState extends State<Rejectautres> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Autres Echantillons Réjetés',
      ...
      body: Column(
        children: [
          ...
          Text("Aucun autre échantillon réjeté")
