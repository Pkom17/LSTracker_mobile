...
class Retrievehpv extends StatefulWidget {
  const Retrievehpv({super.key});

  @override
  State<Retrievehpv> createState() => _RetrievehpvState();
}

class _RetrievehpvState extends State<Retrievehpv> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Liste des résultats HPV récupérés',
