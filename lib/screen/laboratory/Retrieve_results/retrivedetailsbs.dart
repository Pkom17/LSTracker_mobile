...
import '../../listes/retrieve/retrievebs.dart';

class Retrivedetailsbs extends StatelessWidget {
  const Retrivedetailsbs({super.key});
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => Retrievebs()));
        },
        child: Stack(
          children: [
            Column(
