...
import '../../listes/Accept_samples/accept_sampletb.dart';

class Acceptdetailstb extends StatelessWidget {
  const Acceptdetailstb({super.key});
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => AcceptSampletb()));
        },
        child: Stack(
          children: [
            Column(
