...
class Editdistrict extends StatefulWidget {
  const Editdistrict({super.key, required this.districtModels});
  final DistrictModels districtModels;
...
class _EditdistrictState extends State<Editdistrict> {
  ...
  void initState() {
    ...
    _districtController = TextEditingController(
      text: widget.districtModels.namedistrict,
    );
  }
  ...
  Future _updateDistrict() async {
    DistrictModels updateDistrict = DistrictModels(
      iddistrict: widget.districtModels.iddistrict,
      namedistrict: _districtController.text,
    );
    await DatabaseHelper.instance.updateDistrict(updateDistrict);
