...
import '../../listes/disponibility_result/disporesultcv.dart';

class Resultdetailscv extends StatelessWidget {
  const Resultdetailscv({super.key});
    ...
    return Card(
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.of(
            context,
          ).push(MaterialPageRoute(builder: (context) => Disporesultcv()));
        },
        child: Stack(
          children: [
            Column(
