...
import '../../listes/Collect_result/resultcv.dart';

class ResultcollectDetails extends StatelessWidget {
  const ResultcollectDetails({super.key});
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => Resultcv()));
        },
        child: Stack(
          children: [
            Column(
