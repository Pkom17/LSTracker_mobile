...
class Resulthpv extends StatefulWidget {
  const Resulthpv({super.key});

  @override
  State<Resulthpv> createState() => _ResulthpvState();
}

class _ResulthpvState extends State<Resulthpv> {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Text("Resultats HPV pas disponibles")
