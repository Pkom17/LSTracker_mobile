...
class Retrieveautres extends StatefulWidget {
  const Retrieveautres({super.key});

  @override
  State<Retrieveautres> createState() => _RetrieveautresState();
}

class _RetrieveautresState extends State<Retrieveautres> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Liste des autres résultats récupérés',
      ...
      body: Column(
        children: [
          ...
          Text("Aucun autre récupération disponible")
