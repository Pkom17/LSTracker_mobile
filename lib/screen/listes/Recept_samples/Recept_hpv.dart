...
class ReceptHpv extends StatefulWidget {
  const ReceptHpv({super.key});

  @override
  State<ReceptHpv> createState() => _ReceptHpvState();
}

class _ReceptHpvState extends State<ReceptHpv> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Réceptionner Echantiilons HPV',
      ...
      body: Column(
        children: [
          ...
          Text("Reception des Echantillons de HPV pas disponibles")
