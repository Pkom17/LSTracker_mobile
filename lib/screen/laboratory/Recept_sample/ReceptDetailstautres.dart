...
import '../../listes/Recept_samples/Recept_autres.dart';

class Receptdetailstautres extends StatelessWidget {
  const Receptdetailstautres({super.key});
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => Receptautres()));
        },
        child: Stack(
          children: [
            Column(
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        "Réceptionner autres Echantillons",
                        style: GoogleFonts.lato(
