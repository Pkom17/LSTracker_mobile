...
import '../../listes/Recept_samples/Recept_bs.dart';

class Receptdetailsbs extends StatelessWidget {
  const Receptdetailsbs({super.key});
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => ReceptBs()));
        },
        child: Stack(
          children: [
            Column(
