...
import '../../listes/Recept_samples/Recept_cv.dart';

class Receptdetailscv extends StatelessWidget {
  const Receptdetailscv({super.key});
    ...
    return Card(
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.of(
            context,
          ).push(MaterialPageRoute(builder: (context) => ReceptCv()));
        },
        child: Stack(
          children: [
            Column(
