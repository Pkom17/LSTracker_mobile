...
class Resultbs extends StatefulWidget {
  const Resultbs({super.key});

  @override
  State<Resultbs> createState() => _ResultbsState();
}

class _ResultbsState extends State<Resultbs> {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Text("Resultats BS pas disponibles")
