...
class Disporesultbi extends StatefulWidget {
  const Disporesultbi({super.key});

  @override
  State<Disporesultbi> createState() => _DisporesultbiState();
}

class _DisporesultbiState extends State<Disporesultbi> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Liste des résultats BI disponible',
      ...
      body: Column(
        children: [
          ...
          Text("Résultats BI pas disponibles")
