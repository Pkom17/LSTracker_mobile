...
class Depositautre extends StatefulWidget {
  const Depositautre({super.key});

  @override
  State<Depositautre> createState() => _DepositautreState();
}

class _DepositautreState extends State<Depositautre> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Listes des autres type d\' échantillons à déposer',
      ...
      body: Column(
        children: [
          ...
          Text("Autres échantillons à déposer")
