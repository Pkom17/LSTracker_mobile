...
class Rejectcv extends StatefulWidget {
  const Rejectcv({super.key});

  @override
  State<Rejectcv> createState() => _RejectcvState();
}

class _RejectcvState extends State<Rejectcv> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Echantillons Réjetés CV',
      ...
      body: Column(
        children: [
          ...
          Text("Aucun des échantillons CV réjetés")
