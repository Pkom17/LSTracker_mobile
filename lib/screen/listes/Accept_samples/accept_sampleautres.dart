...
class AcceptSampleAutres extends StatefulWidget {
  const AcceptSampleAutres({super.key});

  @override
  State<AcceptSampleAutres> createState() => _AcceptSampleAutresState();
}

class _AcceptSampleAutresState extends State<AcceptSampleAutres> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'Accepter Autres Echantillons',
      ...
      body: Column(
        children: [
          ...
          Text("Aucun autre échantillon à accepter")
