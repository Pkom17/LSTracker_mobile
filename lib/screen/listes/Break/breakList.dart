...
class Breaklist extends StatefulWidget {
  const Breaklist({super.key});

  @override
  State<Breaklist> createState() => _BreaklistState();
}

class _BreaklistState extends State<Breaklist> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          "Liste des ruptures d'intrants ",
