...
import '../../listes/Collect_result/resulttb.dart';

class Resultdetailstb extends StatelessWidget {
  const Resultdetailstb({super.key});
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.of(context)
              .push(MaterialPageRoute(builder: (context) => Resulttb()));
        },
        child: Stack(
          children: [
            Column(
